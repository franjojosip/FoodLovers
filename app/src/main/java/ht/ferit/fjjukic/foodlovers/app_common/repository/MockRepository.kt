...
class MockRepository {
    ...
    companion object {
        ...
        private fun getCategoryID(category: String): String {
            return categories.first { it.name.contains(category, true) }.id
        }

        private fun getDifficultyID(difficulty: String): String {
            return difficulties.first { it.name.contains(difficulty, true) }.id
        }
